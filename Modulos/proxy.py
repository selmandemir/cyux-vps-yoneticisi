        ...
        try:
            ...
            if hostPort != '':
                ...
                if len(PASS) != 0 and passwd == PASS:
                    ...
                    self.client.send(b'HTTP/1.1 400 YanlisSifre!\r\n\r\n')
                elif hostPort.startswith(IP):
                    self.method_CONNECT(hostPort)
                else:
                    self.client.send(b'HTTP/1.1 403 Yasakli!\r\n\r\n')
            else:
                print('- X-Real-Host Bulunamadi!')
                self.client.send(b'HTTP/1.1 400 XRealHostYok!\r\n\r\n')
